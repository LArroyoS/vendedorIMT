...
/*
    $productos = ControladorProductos::ctrListarProductos('id',null,null);

    foreach($productos as $key=>$producto){

        $datos1 = array("valor"=>rand(5, 15),
                        "ruta"=>$producto['ruta'] );

        $item1 = 'peso';

        ControladorProductos::ctrActualizarVistaProducto($datos1,$item1);
